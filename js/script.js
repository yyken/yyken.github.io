      ...
      var html = [
        '<div id="' + id + '" class="article-share-box">',
          '<div class="article-share-links">',
            '<a href="https://twitter.com/share?url=' + encodedUrl + '&text=' + summary + '" class="article-share-twitter" target="_blank" title="Twitter"></a>',
            '<a href="http://www.facebook.com/sharer/sharer.php?u=' + encodedUrl + '&t=' + title + '" class="article-share-facebook" target="_blank" title="Facebook"></a>',
